...
namespace Drenagem.Setup
{
    public static class Constantes
    {
        public static readonly List<String> PrefixoDoNomeDosBlocos = new List<String>
            ...
            "CP_2.40_2.40","CP_2.60_2.60", "CP_3.20_1.80","CP_3.20_3.20", "CDS_2.60_1.60", "CDS_2.20_1.40", "CDS_2.60_1.20", "CDS_2.80_1.80", "CDS_2.20_1.20" };
    ...
    public static class ConstantesTubulacao
    {
        ...
        {"TUBO FF DN 150" , "TUBO FF DN 200" , "TUBO FF DN 250", "TUBO FF DN 300","TUBO FF DN 350","TUBO FF DN 400","TUBO FF DN 450","TUBO FF DN 500",
