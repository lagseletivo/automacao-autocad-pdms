...
namespace Drenagem
{
    class SelecaoDosTextosTubulacao
    {
        ...
        static public void ZoomWindow()
        {
            ...
            foreach (AtributosDoBloco atributo in _lista)
            {
                TextoElevacao Elevacao1 = new TextoElevacao();

                Point3d p1 = new Point3d(atributo.X - 5, atributo.Y + 5, 0);
                Point3d p2 = new Point3d(atributo.X + 5, atributo.Y + 5, 0);
                Point3d p3 = new Point3d(atributo.X + 5, atributo.Y - 5, 0);
                Point3d p4 = new Point3d(atributo.X - 5, atributo.Y - 5, 0);
